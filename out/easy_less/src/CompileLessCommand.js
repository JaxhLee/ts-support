    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                StatusBarMessage.show(`$(check) TSS: Less compiled in ${elapsedTime}ms`, 0 /* SUCCESS */);
            }
            catch (error) {
                compilingMessage.dispose();
                ...
                StatusBarMessage.show("$(alert) TSS: Error compiling less (more detail in Problems)", 2 /* ERROR */);
            }
        });
    }
